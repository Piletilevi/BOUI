    ...
    return {
      ...
      link: function ($scope, $element, $attributes) {
        ...
        if (piletilevi.venuemap.Config.type === 'seats') {
          ...
          $element.append('<button class="btn_zoomout" type="button">-</button> ' +
            '<button class="btn_zoomin" type="button">+</button> ' +
            '<button class="btn_zoomreset" type="button">Reset Zoom</button>');
