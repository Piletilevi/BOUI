        ...
        function search () {
            ...
            for (var group in storage) {
                ...
                for (var i in storage[group]) {
					...
					if (typeof storage[group][i].display === "undefined") {
						continue;
					}
                    ...
                    "html": function() {
                        ...
                        for (var i in result) {
                            ...
                            (function (result, scope) {
                                ...
                                if (options.group) {
                                    _handle = $(scope).find('li[data-group="' + _group + '"]:last').closest('li');
                                    if (!_handle[0]) {
                                        _handle = $(scope).find('li.typeahead-list:last');
                                    }
                                    $(_handle).append(_divHtml);

                                } else {
                                    $(scope).append(_divHtml);
                                }
